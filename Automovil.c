...
//-----------------------------------------------------------------------------------------------//
void eAutomovil_init(eAutomovil listadoAutomoviles[])
{
	int i;
...
//-----------------------------------------------------------------------------------------------//
int eAutomovil_pedirIdYBuscar(eAutomovil listadoAutomoviles[])
{
	int retorno;
	int idAutomovil;
...
//-----------------------------------------------------------------------------------------------//
int eAutomovil_informarExisteIdPropietario(eAutomovil listadoAutomoviles[], int idPropietario)
{
	int retorno = 0;
	int i;
...
void eAutomovil_bajaPropietario(eAutomovil listadoAutomoviles[], ePropietario listadoPropietarios[], int limitePropietarios)
{
	...
	ePropietario_baja(listadoPropietarios, limitePropietarios);
